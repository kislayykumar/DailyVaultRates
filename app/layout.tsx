...
export default function RootLayout({
 ...
 return (
   <html lang="en" className="dark">
     ...
     <body className="flex min-h-screen flex-col text-slate-100 antialiased selection:bg-[rgba(0,212,255,0.20)] selection:text-[#00D4FF]" style={{ background: "#040810", fontFamily: "'Space Grotesk', 'Inter', system-ui, -apple-system, sans-serif" }}>
       <Providers>
         <Navbar />
